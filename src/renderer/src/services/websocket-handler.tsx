...
import { WebSocketContext, HistoryInfo, defaultWsUrl, defaultBaseUrl } from '@/context/websocket-context';
...
function WebSocketHandler({ children }: { children: React.ReactNode }) {
  ...
  return <WebSocketContext.Provider value={webSocketContextValue}>{children}</WebSocketContext.Provider>;
}
